...
type TabType = 'all' | 'admin' | 'Kepala Sekolah' | 'guru' | 'siswa';
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex overflow-x-auto gap-2 bg-white p-2 rounded-xl border border-gray-200 shadow-sm no-scrollbar">
          {[
              ...
              { id: 'Kepala Sekolah', label: 'Kepala Sekolah', icon: Briefcase },
              ...
              <tr key={user.id} className={selectedIds.includes(user.id) ? 'bg-indigo-50/50' : ''}>
                ...
                <td className="p-4">
                    <span className={`px-2 py-1 text-xs font-bold rounded-full border ${
                        ...
                        user.role === 'Kepala Sekolah' ? 'bg-purple-50 text-purple-700 border-purple-200' : 
