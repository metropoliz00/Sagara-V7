        ...
        {activeTab === 'karakter' && (
             ...
             <div className="overflow-x-auto">
                <table className="w-full text-xs text-left border-collapse min-w-[1200px]">
                    <thead className="bg-slate-50 text-slate-700 font-bold sticky top-0">
                        <tr className="border-b">
                            <th className="p-3 border sticky left-0 bg-slate-50 z-20 w-12 text-center">No</th>
                            <th className="p-3 border sticky left-12 bg-slate-50 z-20 w-48">Nama Siswa</th>
                    ...
                    <tbody className="divide-y divide-gray-100">
                        {students.map((student, idx) => {
                            ...
                            return (
                            <tr key={student.id} className="hover:bg-gray-50">
                                <td className="p-3 border text-center font-medium sticky left-0 bg-white z-10 w-12">{idx + 1}</td>
                                <td className="p-3 border font-medium sticky left-12 bg-white z-10 group-hover:bg-gray-50 uppercase">{student.name.toUpperCase()}</td>
