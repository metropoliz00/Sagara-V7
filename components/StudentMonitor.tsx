...
const StudentMonitor: React.FC<StudentMonitorProps> = ({
  ...
  const attendanceStats = useMemo(() => {
    if (!selectedStudent) return { counts: { sick: 0, permit: 0, alpha: 0 }, semesterName: 'Genap', startMonthName: 'Januari', endMonthName: 'Juni' };
    ...
    return { 
        ...
        startMonthName: isSemester1 ? 'Juli' : 'Januari',
        endMonthName: isSemester1 ? 'Desember' : 'Juni'
    };
                    ...
                    <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                        <div className="flex flex-col items-center">
                            ...
                            <div className="w-full bg-gray-50 rounded-xl p-3 mb-4 border border-gray-100">
                                <p className="text-[10px] font-bold text-gray-400 uppercase text-center mb-2">REKAP SMT {attendanceStats.semesterName.toUpperCase()} ({attendanceStats.startMonthName} - {attendanceStats.endMonthName})</p>
