...
import { Student, TeacherProfileData, SeatingLayouts, User as DbUser } from '../../types';
...
const SeatingTab: React.FC<SeatingTabProps> = ({ seatingLayouts, setSeatingLayouts, students, onSave, teacherProfile, users, classId }) => {
            ...
            {student ? (
                <>
                    {student.photo && !student.photo.startsWith('ERROR') ? (
                        <img src={student.photo} alt="" className="w-8 h-8 rounded-full object-cover object-top border border-gray-200 mb-1 pointer-events-none" />
                    ) : (
